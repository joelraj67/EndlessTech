...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-[92vh] items-center overflow-hidden bg-bg pb-20 pt-32">
      {/* Multi-stop atmospheric mesh */}
      <div className="pointer-events-none absolute left-1/2 top-0 h-[550px] w-[900px] -translate-x-1/2 rounded-full opacity-40 blur-[180px]"
        style={{ background: 'radial-gradient(ellipse, rgba(56,189,248,0.25) 0%, rgba(30,41,59,0.5) 45%, transparent 75%)' }} />
      <div className="pointer-events-none absolute -left-32 top-1/4 h-[420px] w-[420px] rounded-full opacity-25 blur-[150px]"
        style={{ background: 'rgba(244,114,182,0.2)' }} />
      <div className="pointer-events-none absolute -right-20 bottom-1/4 h-[320px] w-[320px] rounded-full opacity-20 blur-[120px]"
      ...
      <Container className="relative w-full">
        <div className="mx-auto max-w-[880px] text-center">
          ...
          {/* Hero Metric with high contrast text */}
          <div className="mx-auto flex max-w-[580px] flex-col items-center gap-1 border-t border-white/15 pt-7 font-mono text-xs text-slate-300 sm:flex-row sm:justify-center sm:gap-3">
